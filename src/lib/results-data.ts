...
export const mainEventResults = {
  ...
  'supercross-2': { // San Diego
    ...
    '450_heat2': [
      ...
      { pos: 15, rider: 'Zack Williams', number: '874', bike: 'Honda' },
      { pos: 16, rider: 'Logan Karnow', number: '169', bike: 'Kawasaki' },
      { pos: 17, rider: 'Dayton Briggs', number: '734', bike: 'KTM' },
      { pos: 18, rider: 'Josh Greco', number: '976', bike: 'Kawasaki' },
      { pos: 19, rider: 'Robert Hailey III', number: '289', bike: 'Yamaha' },
      { pos: 20, rider: 'Austin Forkner', number: '33', bike: 'Triumph' }
    ],
    '250_heat1': [
