...
export function Header() {
  ...
  const AppIcon = ({ className }: { className?: string }) => (
    ...
    >
      <path
        d="M17 2H7C5.34315 2 4 3.34315 4 5V19C4 20.6569 5.34315 22 7 22H17C18.6569 22 20 20.6569 20 19V5C20 3.34315 18.6569 2 17 2ZM18 19C18 19.5523 17.5523 20 17 20H7C6.44772 20 6 19.5523 6 19V5C6 4.44772 6.44772 4 7 4H17C17.5523 4 18 4.44772 18 5V19ZM16 7H8V17H16V7Z M15 18H9V19H15V18Z"
        fillRule="evenodd"
        fill="currentColor"
      />
    </svg>
            ...
            <Sheet>
                <SheetTrigger asChild>
                    <Button variant="ghost" size="icon" className="h-12 w-12">
                        <Menu className="h-10 w-10 text-primary-foreground" />
