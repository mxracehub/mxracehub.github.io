...
const seriesPoints450 = [
    { pos: 1, rider: 'Jett Lawrence', number: '18', bike: 'Honda', points: 25 },
    { pos: 2, rider: 'Chase Sexton', number: '4', bike: 'KTM', points: 22 },
    { pos: 3, rider: 'Eli Tomac', number: '3', bike: 'Yamaha', points: 20 },
    ...
    { pos: 8, rider: 'Hunter Lawrence', number: '96', bike: 'Honda', points: 14 },
    { pos: 9, rider: 'Dylan Ferrandis', number: '14', bike: 'Honda', points: 13 },
    { pos: 10, rider: 'Justin Barcia', number: '51', bike: 'GasGas', points: 12 },
];

const seriesPoints250West = [
    { pos: 1, rider: 'RJ Hampshire', number: '24', bike: 'Husqvarna', points: 25 },
    { pos: 2, rider: 'Levi Kitchen', number: '47', bike: 'Kawasaki', points: 22 },
    { pos: 3, rider: 'Jordon Smith', number: '31', bike: 'Yamaha', points: 20 },
    { pos: 4, rider: 'Jo Shimoda', number: '30', bike: 'Honda', points: 18 },
    { pos: 5, rider: 'Garrett Marchbanks', number: '26', bike: 'Yamaha', points: 17 },
    { pos: 6, rider: 'Max Vohland', number: '20', bike: 'Kawasaki', points: 16 },
    { pos: 7, rider: 'Nate Thrasher', number: '57', bike: 'Yamaha', points: 15 },
    { pos: 8, rider: 'Julien Beaumer', number: '99', bike: 'KTM', points: 14 },
    { pos: 9, rider: 'Anthony Bourdon', number: '100', bike: 'Suzuki', points: 13 },
    { pos: 10, rider: 'Carson Mumford', number: '41', bike: 'Honda', points: 12 },
];

const seriesPoints250East = [
    { pos: 1, rider: 'Austin Forkner', number: '64', bike: 'Kawasaki', points: 25 },
    { pos: 2, rider: 'Cameron McAdoo', number: '63', bike: 'Kawasaki', points: 22 },
    { pos: 3, rider: 'Tom Vialle', number: '16', bike: 'KTM', points: 20 },
    { pos: 4, rider: 'Pierce Brown', number: '39', bike: 'GasGas', points: 18 },
    { pos: 5, rider: 'Haiden Deegan', number: '38', bike: 'Yamaha', points: 17 },
    { pos: 6, rider: 'Max Anstie', number: '37', bike: 'Honda', points: 16 },
    { pos: 7, rider: 'Coty Schock', number: '69', bike: 'Yamaha', points: 15 },
    { pos: 8, rider: 'Jalek Swoll', number: '33', bike: 'Triumph', points: 14 },
    { pos: 9, rider: 'Daxton Bennick', number: '59', bike: 'Yamaha', points: 13 },
    { pos: 10, rider: 'Seth Hammaker', number: '43', bike: 'Kawasaki', points: 12 },
];
